...
def Loop_within_episode_1_bis(v_0,v_0_past,s_init,x_init,q_init,pdic,gamma =0.01,Error=None, nb_init = 1):
    ####### Initial condition
    ...
    for i in range(pdic['nb_iter']): # i = 10
        ...
        i_max = np.argmax(vect_values) ## select best reward
        v_0_cum[i,indexq_q] += vect_values[i_max] ## update v_0_cum
        
        ## update v_0
        nb_init_bis = nb_init
        v_0[i,indexq_q] = v_0[i,indexq_q] + (gamma/(nb_init_bis))*v_0_cum[i,indexq_q]
...
def Loop_all_episode_1_bis(nb_episode,pdic, gamma= 0.2,freq_print=100,Error=None, v_0 = None, v_0_past = None, print_option =  True, pctg_0 = 0.01):
    ...
    for ep in range(nb_episode): # ep = 0
        ...
        v_0,error_val,v_0_past = Loop_within_episode_1_bis(v_0,v_0_past, s_init,x_init,q_init,pdic,gamma =gamma, Error = Error, nb_init=nb_init_0)
