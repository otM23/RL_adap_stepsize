...
Error = lambda x : Estim_mean_no_link_pass_2.error_1(h_0theo,x)
...
Estim_mean_no_link_pass_2.Plot_plot(df,labels, xlabel ="Number of iteration", ylabel ="Log L2 - error",
