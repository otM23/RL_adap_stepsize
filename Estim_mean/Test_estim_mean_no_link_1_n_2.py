# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 19:42:24 2019
...
Error = lambda x : Estim_mean_no_link_1_n_2.error_1(h_0theo,x)


#### Benchmark : gamma = 1/n ***
h_0 = np.array(h_0_init) # 100*np.random.rand(pdic['nb_iter'])#
pctg_0 = 0.01
h_01_bis,h_01_bis_past, error_h01_bis = Estim_mean_no_link_1_n_2.Loop_super1_bis(nb_episode,pdic,gamma= gamma,s_value=s_value,Error=Error,freq_print=freq_print,h_0=h_0,pctg_0=pctg_0)
print(h_01_bis.mean())
...
start = 0
option_save = ""
path_Image = "Image"; ImageName = "\\improvement_drift_estim_1_n"
df = [ [error_h01_bis[start:,0],np.log(error_h01_bis[start:,1])]]

labels = ["benchmark_1_n"]
mark = ['o']
fig = plt.figure(figsize=(8,5))
Estim_mean_no_link_1_n_2.Plot_plot(df,labels, xlabel ="Number of iteration", ylabel ="Log L2 - error",
