...
pctg_0 = 0.01
h_01,h_01_past,error_h01 = Estim_mean_no_link_bench_2.Loop_super1(nb_episode,pdic,gamma= gamma,s_value=s_value,Error=Error,freq_print=freq_print,h_0=h_0,nb_iter = nb_iter,pctg_0 = pctg_0)
print(h_01.mean())
...
Estim_mean_no_link_bench_2.Plot_plot(df,labels, xlabel ="Number of iteration", ylabel ="Log L2 - error",
