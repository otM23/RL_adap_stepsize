...
####### Import liraries 
import Optimal_placing_reduced_no_link_bench_2 as op_place
import numpy as np 
import pandas as pd
...
df_bis = op_place.Sol_num_scheme(nb_iter_scheme,size_q,Intens_val_bis,tol = tol,reward_exec_1 = reward_exec_1)
...
h_0_theo = op_place.Read_h_0_theo(df_bis["Value_opt"].values,size_q,reward_exec_1)
Error = lambda x : op_place.error_1(np.nan_to_num(h_0_theo),np.nan_to_num(x))
