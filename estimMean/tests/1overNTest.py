...
### Import libraries
import oneOverN as Estim_mean_1_n
...
pctg_0 = 0.01
h_01_bis,h_01_bis_past, error_h01_bis = Estim_mean_1_n.Loop_super1_bis(nb_episode,pdic,gamma= gamma,s_value=s_value,Error=Error,freq_print=freq_print,h_0=h_0,pctg_0=pctg_0)
