...
### Import libraries
import saga as Estim_mean_saga
...
pctg_0 = 0.01
h_06,h_0_past6,nb_past6,error_h06 = Estim_mean_saga.Loop_super4(nb_episode,_exp_mean,pdic,inner_loop_func=Estim_mean_saga.Loop4_2,n_max=n_max,gamma= gamma,s_value=s_value,Error = Error,freq_print=freq_print,h_0=h_0,pctg_0 =pctg_0)
print(h_06.mean())
